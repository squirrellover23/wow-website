...
db.serialize(() => {
    db.run("CREATE TABLE IF NOT EXISTS names (firstName TEXT COLLATE NOCASE, lastName TEXT COLLATE NOCASE, total_visits INT DEFAULT 0, enrolled_class_visits INT DEFAULT 0, visits_since_vouch INT DEFAULT 0, vouchers_received INT DEFAULT 0, class TEXT COLLATE NOCASE, lastLoginTime INT DEFAULT 0)");
